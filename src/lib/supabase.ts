...
// Cookie-based browser client (via @supabase/ssr) so the anon session is carried
// in cookies and visible to middleware + server components. Everything importing
// `@/lib/supabase` keeps working unchanged.
